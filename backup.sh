...
sudo tar -czf - --exclude=backup_packages --exclude=backup.tar.gz --exclude=/bin --exclude=/home/desktop --exclude=/var/lib/docker/overlay2 --exclude=/media --exclude=/dev --exclude=/mnt --exclude=/proc  --exclude=/sys --exclude=/tmp / | split -b 256m - "/media/backup/os_backup-part"
